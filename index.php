...
<nav class="navbar navbar-expand-lg navbar-light bg-light bg-body-tertiary">
    <a class="navbar-brand" href="#">Caroline Warner - SE266</a>
            ...
            <ul class="dropdown-menu test">
                ...
                <li>
                  ...
                  <div class="btn-group dropright">
                    <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <div class="dropdown-menu">
                        <a target="_blank" class="dropdown-item" href="https://docs.github.com/en/get-started/using-git">GitHub Docs</a>
                        <a target="_blank" class="dropdown-item" href="https://www.w3schools.com/git/">W3 Schools</a>
                        <a target="_blank" class="dropdown-item" href="https://stackoverflow.com/questions/315911/git-for-beginners-the-definitive-practical-guide">Stack Overflow</a>                      
                    </div>
                  </div>
                  <!--<div class="btn-group dropright">
                    <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a target="_blank" class="dropdown-item" href="https://www.w3schools.com/git/">W3 Schools</a></li>
                ...
                <li><button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            PHP
            </button></li>
            </ul>
          </div>
